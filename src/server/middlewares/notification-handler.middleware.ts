...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'saved_search.create': {
    ...
    key: 'team-member-saved-search',
    tenantPath: ['company', 'user', 'saved_search'],
    userPath: [],
  },
  'saved_search.update': {
    roles: ['business-owner', 'research-analyst'],
    key: 'research-analyst-updated-search',
    tenantPath: ['company', 'user', 'saved_search'],
    userPath: [],
  },
  'saved_search.delete': {
    roles: ['business-owner', 'team-member'],
    key: 'team-member-deleted-search',
    tenantPath: ['company', 'user', 'saved_search'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'research-analyst'];
