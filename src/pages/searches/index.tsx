...
export function SearchListPage(props: SearchListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getSearches({
        relations: ['user', 'saved_search.count', 'trend_search.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['query.contains', 'filter.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'filter', header: 'Filter', accessorKey: 'filter' },
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('saved_search', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'saved_search',
          header: 'Saved Search',
          accessorKey: 'saved_search',
          cell: ({ row: { original: record } }: any) => record?._count?.saved_search,
        }
      : null,
    hasAccess('trend_search', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'trend_search',
          header: 'Trend Search',
          accessorKey: 'trend_search',
          cell: ({ row: { original: record } }: any) => record?._count?.trend_search,
        }
      : null,
