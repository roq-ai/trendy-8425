  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover, Analyze and Capitalize on the Latest Internet Trends with Trendy - Your Corporate Gateway to the Pulse of the Digital World."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1666635376182-347aa9fb37ed?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnRlcm5ldCUyMHRyZW5kc3xlbnwwfHx8fDE2OTQ0Njc1OTJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover, Analyze and Capitalize on the Latest Internet Trends with Trendy - Your Corporate Gateway to the Pulse of the Digital World.`}
            </Text>
            <Box
